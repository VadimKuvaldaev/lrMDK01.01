...
namespace ChartTest
{
    public partial class MainForm : Form
    {
        ...
        void FillSolid()
        {
            ...
            angular.Sections.Add(new AngularSection
            {
                FromValue = 70, 
                ToValue = 80,
                Fill = new SolidColorBrush(Color.FromRgb(100, 0, 0))
            }
            );
            solid.Base.LabelsVisibility = System.Windows.Visibility.Hidden;
